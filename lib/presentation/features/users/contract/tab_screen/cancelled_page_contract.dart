...
class CancelledContractsPage extends StatefulWidget {
  const CancelledContractsPage({super.key});

  @override
  State<CancelledContractsPage> createState() => _CancelledContractsPageState();
}

class _CancelledContractsPageState extends State<CancelledContractsPage> {
  @override
  void initState() {
    super.initState();
    // Fetch cancelled contracts when page loads
    WidgetsBinding.instance.addPostFrameCallback((_) {
      context.read<ContractProvider>().fetchCancelledContracts();
    });
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Consumer<ContractProvider>(
      builder: (context, provider, child) {
        // Loading state
        if (provider.isLoading && provider.cancelledContracts.isEmpty) {
          return Center(
        ...
        // Error state
        if (provider.errorMessage != null && provider.cancelledContracts.isEmpty) {
          return Center(
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 16),
                ElevatedButton(
                  onPressed: () => context.read<ContractProvider>().fetchCancelledContracts(),
        ...
        final contracts = provider.cancelledContracts;
          ...
          return Center(
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 8),
                Text(
                  'You don\'t have any cancelled contracts',
                  style: AppTextStyle.dmSans(
                    fontSize: 12.0,
                    color: isDark ? JAppColors.darkGray100 : JAppColors.lightGray800,
                    weight: FontWeight.w500,
                ...
                itemBuilder: (context, index) {
                  ...
                  return Padding(
                    ...
                    child: ContractCard(
                      ...
                      dateRange: '${contract.startDate} - Cancelled',
