...
class ApplicationProvider with ChangeNotifier {
  ...
  // ✅ Same type JobApplicationResponse — but now data is List<MyJobApplication>
  JobApplicationResponse? _myApplications;
  JobApplicationResponse? get myApplications => _myApplications;
  ...
  Future<void> deleteApplication(String id) async {
    ...
    try {
      ...
      _error = e.toString();
      Fluttertoast.showToast(msg: _error!, toastLength: Toast.LENGTH_SHORT);
    } finally {
      _isLoading = false;
      notifyListeners();
    }
  ...
  Future<void> updateApplication(
      String id, UpdateApplicationRequest request) async {
    _isLoading = true;
    _error = null;
    notifyListeners();
  ...
  // ✅ _myApplications.data is now List<MyJobApplication> — fully typed
